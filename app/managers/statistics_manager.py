...
class StatisticsManager:
    ...
    async def get_brief_subject_analysis(self, subject: SubjectForBriefAnalysis):
        ...
        return BriefAnalysis(
            ...
            city_complaints_count_per_status={
                record["petition_status"]: record["count"]
                for record in city_complaints_count_per_status
                },
            city_initiatives_count_per_status={
                record["petition_status"]: record["count"]
                for record in city_initiatives_count_per_status
                },
            region_complaints_count_per_status={
                record["petition_status"]: record["count"]
                for record in region_complaints_count_per_status
                },
            region_initiatives_count_per_status={
                record["petition_status"]: record["count"]
                for record in region_initiatives_count_per_status
                }
        )
    ...
    async def get_full_statistics(self, region: RegionForDetailedAnalysis):
        ...
        (
            ...
            self._get_most_popular_petitions(
                region.region_name, True, region.start_time,
                region.end_time, region.rows_count, region.city_name
                ),
            self._get_most_popular_petitions(
                region.region_name, False, region.start_time,
                region.end_time, region.rows_count, region.city_name
                ),
